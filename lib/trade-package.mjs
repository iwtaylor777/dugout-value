...
// A 40% common component is intentionally conservative: a multi-player return
// diversifies some scouting/injury risk, but never pretends the assets are
// independent or that the projection system itself is certain.
